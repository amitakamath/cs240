...
static void CheckContextSwitch() {
  ...
  // std::cout << context_a.r12<<std::endl;
  // std::cout << context_b.r12<<std::endl;
  // std::cout << context_a.r13<<std::endl;
  // std::cout << context_b.r13<<std::endl;
  // std::cout << context_a.r14<<std::endl;
  // std::cout << context_b.r14<<std::endl;
  // std::cout << context_a.r15<<std::endl;
  // std::cout << context_b.r15<<std::endl;
